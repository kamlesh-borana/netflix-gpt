...
const Header = () => {
  ...
  return (
    <div className="w-full absolute z-10 top-0 flex items-center justify-between z-50 flex-col md:flex-row">
      <div className="w-32 m-4 md:m-8">
      ...
      {user?.isLoggedIn && (
        <div className="flex items-center md:mr-8">
          ...
          <img
            ...
            alt="User Avatar"
          />
          <span className="mr-4 text-white hidden md:block">{name}</span>
          <button
            className="bg-white text-black text-sm py-1 px-2 rounded-lg"
